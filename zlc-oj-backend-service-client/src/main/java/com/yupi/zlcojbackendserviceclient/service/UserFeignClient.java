...
import com.yupi.zlcojbackendjudemode.model.dto.user.UserQueryRequest;
...
import static com.yupi.zlcojbackendjudecommon.constant.UserConstant.USER_LOGIN_STATE;
...
@FeignClient(name = "zlc-oj-backend-user-service", path = "/api/user/inner")
